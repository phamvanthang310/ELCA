    ...
    <div class="row">
      <div id="left-nav" class="col-md-2">
        ...
        <ul class="list-unstyled">
          <li><a href="/new" class="active"><@spring.message "text.project"/></a></li>
      ...
      <div id="main-container" class="col-md-10">
        <div class="row" id="sub-header">
          <div class="col-md-12">
            <h4 class="semibold"><@spring.message "text.new.project"/></h4>
            <div class="divider"></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            ...
            <form id="project-form" class="form-horizontal" name="detailForm" novalidate action="/add" method="POST">

              <div class="form-group">
                <label for="projectNumber" class="col-md-2 control-label"><@spring.message "label.project.number"/> <font>*</font></label>
                <div class="col-md-3 <#if projectError??> has-error </#if>">
                  <input id="projectNumber" maxlength="4" autofocus type="text" class="form-control" name="number" <#if project??> value="${project.number?string["0"]}"  </#if>>
                </div>
                <#if projectError??>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input id="projectName" type="text" class="form-control" name="name" <#if project??> value="${project.name}" </#if>>
                </div>
              </div>
              <div class="form-group">
       ...
       .             <#list groups as group>
                      <option value="${group.groupLeader.visa}">${group.groupLeader.visa}</option>
                    </#list>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-8 <#if visaError??> has-error </#if>">
                  <input id="members" type="text" class="form-control " name="member" >
                </div>
                <#if visaError??>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class='input-group date' id='startdate'>
                    <input id='productStartDate' type='text' class="form-control" name="startDate" <#if project??>value="${project.startDate?string('dd.MM.yyyy')}"  </#if>/> <span class="input-group-addon"> <span
                ...
                <div class="col-md-3">
                  <div class='input-group date' id='enddate'>
                    <input type='text' class="form-control" name="finishingDate" id='productEndDate' /> <span class="input-group-addon" <#if project??><#if project.finishingDate??>value="${project.finishingDate?string('dd.MM.yyyy')}" </#if></#if>/> <span
                      class="glyphicon glyphicon-calendar"></span>
                    </span>
                  </div>
                </div>
              ...
              <div id="button-control" class="col-md-offset-2 col-md-8 ">
                ...
                <button id="create-project" class="btn btn-primary" type="submit"><@spring.message "button.create.project"/></button>
              </div>
            </form>
          </div>
        </div>
